...
docker run --rm -it -v $PWD/cypherapps/data:/batcher/data -v $PWD/logs:/batcher/logs -p 9229:9229 -p 8000:8000 --network cyphernodeappsnet -v $GATEKEEPER_DATAPATH/certs/cert.pem:/batcher/cert.pem:ro --entrypoint ash batcher
npm run start:dev
```
